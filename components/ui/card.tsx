...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        // `[display:grid]` rather than the bare `grid` utility — inside the dashboard
        // shell, `.grid` collides with Adminator's scoped 12-column layout rule (same
        // class name, different meaning), which broke every CardHeader's layout.
